...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoFishData.Entities.AppRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoFishData.Entities.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoFish.Data.Entities.Game", b =>
                {
                    b.HasOne("GoFishData.Entities.AppUser", "CreatedBy")
                        .WithMany()
                    ...
                    b.HasOne("GoFishData.Entities.AppUser", "DeletedBy")
                        .WithMany()
                        .HasForeignKey("DeletedById");

                    b.HasOne("GoFishData.Entities.AppUser", "UpdatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("GoFish.Data.Entities.GamePlayer", b =>
                {
                    ...
                    b.HasOne("GoFishData.Entities.AppUser", "User")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("GoFishData.Entities.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("GoFishData.Entities.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
